# Generated by Django 3.2 on 2024-10-03 16:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message="Поле 'username' может содержатьтолько буквы и цифры.", regex='^[\\w.@+-]+\\Z')], verbose_name='Пользователь')),
