...
Проект написан на версии Python 3.9.12, проследите, чтобы у вас была установлена версия не ниже.
...
```
Обратите внимание, ваша версия Python должна быть не ниже 3.9!
